...
//    private static final String CipherMode = "AES/CFB/NoPadding";//使用CFB加密，需要设置IV
    private static final String CipherMode = "AES";//使用CFB加密，需要设置IV
    ...
    public static String simpleEncrypt(String data, String key) throws Exception {
        try {
    ...
    public static String simpleDecrypt(String data, String key) throws Exception {
        try {
